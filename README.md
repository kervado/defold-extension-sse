...
Desktop macOS/Linux builds link against libcurl. A minimal local shim is used when `curl/curl.h` is not available in the native-extension build environment.
